...
- [Accepted](./rfds/accepted.md)
  - [Inter-agent communication](./rfds/inter-agent-communication/README.md)
    ...
    - [The `jamsession` MCP tool](./rfds/inter-agent-communication/jamsession-tool/README.md)
      - [Implementation plan and status](./rfds/inter-agent-communication/jamsession-tool/implementation.md)
